...
public class ContainerTest {
	...
	public void testToArrayPackage() {
		...
		System.out.println(aContainer.toArrayPackage()[3].getDescription());
		assertEquals(aContainer.toArrayPackage()[1].getDescription(), "Folders");
		assertEquals(aContainer.toArrayPackage()[2].getDescription(), "Papers");
		assertEquals(aContainer.toArrayPackage()[3].getDescription(), "Books");
		assertEquals(aContainer.toArrayPackage()[4].getDescription(), "Pens");
	}
