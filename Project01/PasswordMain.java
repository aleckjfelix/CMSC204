...
public class PasswordMain extends BorderPane {
	...
	public PasswordMain() {
		...
		// _ in label specifies that the next character is the mnemonic, ie, type Alt-e
		// as a shortcut
		...
		try {
			...
			if (PasswordCheckerUtility.isValidPassword(passwordString)) {
				if (PasswordCheckerUtility.isWeakPassword(passwordString)) {
					...
					alert.showAndWait();
					// JOptionPane.showMessageDialog(null, "Password is OK but weak", "Password
	...
	/**
	 * read file of passwords seperated by \n
	 */
	public void readFile() {
		...
		if (selectedFile != null) {
			...
			try {
				...
				illegalPasswords = PasswordCheckerUtility.invalidPasswords(passwords);//changed from validPasswords to invalidPasswords
